...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/11/09 15:31:22 by eddos-sa          #+#    #+#             */
/*   Updated: 2023/11/13 11:41:59 by eddos-sa         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	choose_fractal(t_fractal *fractal, char **argv, int argc)
{
	...
	else if (!ft_strncmp(argv[1], "tricorn", 7) && argc == 2)
		return (tricorn_init(fractal, argv[1]));
	else
		ft_message(3);
	return (EXIT_FAILURE);
}
